...
const GENERAL = {
  tone:
    "Professionell-warmherzig, sachlich-strukturiert, B2B. Klar, hochwertig wirkend, nie clickbait. Kompetent, aber nicht arrogant.",
  audience:
    "Augenarztpraxen und ihr Team: MFAs, Quereinsteiger:innen in die Augenheilkunde, Azubis, Praxismanagement, Ärzt:innen. Ziel: Wissen aufbauen, direkt im Praxisalltag anwenden, Einarbeitung strukturieren.",
  about_knowon:
    "KnowOn ist eine Online-Lernplattform für digitale Weiterbildung in der Augenheilkunde, gegründet von Nadine Dyck mit Sitz in Minden. Angebote: eLearning-Kurse (Anatomie, Optik, Katarakt, Glaukom, Contactlinsen, Notfälle, OCT, refraktive Chirurgie), Webinare, strukturierte Azubi- und Quereinsteiger-Programme, Spezialisierungsqualifikation Augenheilkunde. Mission: Fachwissen in der Augenheilkunde besser vermitteln.",
  dos: [
    ...
    "Praxis-Nutzen konkret machen („direkt im Alltag anwendbar")",
  ...
  donts: [
    ...
    "Kein Clickbait („Du glaubst nicht, was…")",
    "Keine übertriebenen Versprechen („In 3 Tagen zum Experten")",
...
const CHANNELS = {
  linkedin: {
    tone:
      "Professionell-persönlich, Hook in den ersten 2 Zeilen. Kompetent auftreten, gern Gründerinnen-Perspektive (Nadine Dyck).",
    length_guideline: "600-1500 Zeichen, 3-5 Hashtags.",
    cta_style:
      "Subtil, am Ende: „Mehr erfahren: knowon.de" oder Frage an die Community.",
    specific_dos: [
    ...
    notes:
      "Typischer Blueprint für KnowOn-Corporate-News: Anforderung → Partner-Vorstellung → KnowOn-Beitrag → Warum wichtig → Blick nach vorn.",
  },
  instagram: {
    tone:
      "Nahbarer und persönlicher als LinkedIn. 1-3 passende Emojis OK. Visuell denken — die Caption ergänzt das Bild.",
  ...
  eyefox: {
    tone:
      "Sachlich-informativ, B2B-Partnerseiten-Ton für Augenarztpraxen. Kein Social-Media-Spin.",
    ...
    specific_donts: ["Keine Emojis", "Kein Social-Media-Ton", "Keine Hashtags"],
    notes: null,
  },
  newsletter: {
    tone:
      "Direkte, warme Ansprache „Liebes Praxisteam" / „Liebe Kolleg:innen". Eine Kernbotschaft pro Mail.",
    length_guideline:
      "Betreff <55 Zeichen, Preheader 80-120 Zeichen, HTML-Body mit klarer Struktur (h2, p, ul, a, strong).",
  ...
  blog: {
    tone:
      "Informativ, strukturiert, SEO-freundlich. Fachbegriffe erklären, gern mit historischen oder statistischen Fakten anreichern.",
    length_guideline: "600-1000 Wörter, Meta-Description 140-160 Zeichen, 3-6 Tags.",
    cta_style:
      "Am Ende dezenter Verweis auf knowon.de/produkt/... oder die Kontaktseite.",
    specific_dos: [
    ...
    notes:
      "KnowOn nutzt auf der Website H4 als Zwischenüberschriften in Blogposts und markiert einzelne Keywords inline fett.",
  },
};
